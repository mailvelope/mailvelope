...
(function(public) {
  ...
  function init() {
    options.viewModel('getWatchList', initGrid);
  }
  ...
  public.addSite = function(site, hosts) {
    var item = {};
    item.active = true;
    item.site = site;
  ...
  public.removeSite = function(site) {
    if (watchListData) {
      removeWatchListItem(site);
    } else {
      $("#watchListGrid").one('watchListDataReady', (function(site) {
