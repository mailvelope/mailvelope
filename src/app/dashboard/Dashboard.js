      ...
      <div className="row text-center">
        <div className="col-md-6 col-lg-4 mb-3">
          <Link className="card" to="/keyring/display" role="button">
            ...
            <div className="card-footer text-nowrap text-truncate">
              {l10n.map.dashboard_link_manage_keys}
            </div>
          </Link>
        </div>
        <div className="col-md-6 col-lg-4 mb-3">
          <Link className="card" to="/encryption/file-encrypt" role="button">
            <div className="card-body">
        ...
        <div className="col-md-6 col-lg-4 mb-3">
          <Link className="card" to="/settings/security-log" role="button">
            <div className="card-body">
        ...
        <div className="col-md-6 col-lg-4 mb-3">
          <Link className="card" to="/settings/watchlist" role="button">
            <div className="card-body">
        ...
        <div className="col-md-6 col-lg-4">
          <a className="card" href={mailvelopeHelpUrl} target="_blank" rel="noreferrer noopener" role="button">
            <div className="card-body">
