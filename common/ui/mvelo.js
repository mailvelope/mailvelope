...
mvelo.util.showSecurityBackground = function() {
  mvelo.extension.sendMessage({event: "get-security-background"}, function(background) {
    ...
    var secureStyle = ".secureBackground { background-color: " + bgndColor + " !important; background-position: 30% 30% !important; background-image: url(data:image/svg+xml;base64," + btoa(secBgndIcon) + "); }";
