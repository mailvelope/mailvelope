...
mvelo.util.showSecurityBackground = function() {
  mvelo.extension.sendMessage({event: "get-security-background"}, function(background) {
    ...
    var rotationDeg = background.angle; //30;
    var width =  background.width * scale; //45;
    var height = background.height * scale; //25;
    ...
    var secureStyle = ".secureBackground { background-color: " + bgndColor + " !important; background-position: -20px -20px !important; background-image: url(data:image/svg+xml;base64," + btoa(secBgndIcon) + "); }";
    var mmodalStyle = ""; //".modal-body { background-color: " + bgndColor + "; background-image: url(data:image/svg+xml;base64," + btoa(secBgndIcon) + "); }";

    //bgndColor = "tranparent";
    color = "#888888";
    rotationDeg = 0;
    width =  "100%";
    height = "100%";
    ...
    var lockButton = ".lockBtnIcon { background-size: 100% auto; background-repeat: no-repeat;background-image: url(data:image/svg+xml;base64," + btoa(lockIcon) + "); }";
